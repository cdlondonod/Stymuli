 ...
 * @author crist
 */
public class frmupdowntrabajador extends javax.swing.JFrame {

    /**
     * Creates new form frmupanddownload
     */
    public frmupdowntrabajador() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(btndownload, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
...
if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
    ...
    ftrabajador cargar=new ftrabajador();
        cargar.load(path);
...
chooser.setCurrentDirectory(new File  
(System.getProperty("user.home") ));
chooser.setDialogTitle("Descargar Template de Base de datos de trabajadores");
chooser.setVisible(true);
chooser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
chooser.setAcceptAllFileFilterUsed(false);
chooser.setFileFilter(filter);
if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
    ftrabajador descarga=new ftrabajador();
    
        
    path2=chooser.getSelectedFile().toString();
    descarga.download(path2);
    
         JOptionPane.showMessageDialog(rootPane, "El Template de la base de datos trabajadores fue guardado exitosamente, "
  ...
  JOptionPane.showMessageDialog(rootPane, "No se selecciono un lugar para guardar el formato");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmupdowntrabajador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmupdowntrabajador().setVisible(true);
            }
        });
    }
