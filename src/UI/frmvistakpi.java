 ...
 * @author crist
 */
public class frmvistakpi extends javax.swing.JFrame {
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount()==2) {
            ...
            valor=tablalistado.getValueAt(fila, 1).toString();
              ...
              if (conexion.frmabierto==4) {
            frmresultados.txtidkpi.setText(cod);
            frmresultados.txtkpi.setText(valor);
...
mostrar(txtbuscar.getText());         // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistakpi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistakpi().setVisible(true);
            }
        });
    }
