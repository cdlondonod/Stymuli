 ...
 * @author crist
 */
public class frmzfiltrokpi extends javax.swing.JFrame {

    /**
     * Creates new form frmvistaarea
     */
    public frmzfiltrokpi() {
        initComponents();
        mostrar("");
...
{   
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnaceptar, javax.swing.GroupLayout.DEFAULT_SIZE, 211, Short.MAX_VALUE)
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        if (conexion.frmabierto == 1) {
            frmanalisdistrikpi.txtnombrekpi.setText(txtfiltrar.getText());
        } else if (conexion.frmabierto == 5) {
            frmanalisfrecuencia.txtnombrekpi.setText(txtfiltrar.getText());
        }  else if (conexion.frmabierto == 7) {
       
        }  else if (conexion.frmabierto == 9) {
            frmanalisiscompleto.txtnombrekpi.setText(txtfiltrar.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmzfiltrokpi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmzfiltrokpi().setVisible(true);
            }
        });
    }
