 ...
 * @author crist
 */
public class frmzfiltromes extends javax.swing.JFrame {

    /**
     * Creates new form frmvistaarea
     */
    public frmzfiltromes() {
        initComponents();
        mostrar("");
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        if (conexion.frmabierto == 1) {
            frmanalisdistrikpi.txtmes.setText(txtfiltrar.getText());
        } else if (conexion.frmabierto == 5) {
            frmanalisfrecuencia.txtmes.setText(txtfiltrar.getText());
        }  else if (conexion.frmabierto == 7) {
            frmanalisdistriestim.txtmes.setText(txtfiltrar.getText());
        } else if (conexion.frmabierto == 8) {
            frmanalisproyeccion.txtmes.setText(txtfiltrar.getText());
        } else if (conexion.frmabierto == 9) {
            frmanalisiscompleto.txtmes.setText(txtfiltrar.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmzfiltromes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmzfiltromes().setVisible(true);
            }
        });
    }
