 ...
 * @author crist
 */
public class frmzfiltrosubarea extends javax.swing.JFrame {

    /**
     * Creates new form frmvistaarea
     */
    public frmzfiltrosubarea() {
        initComponents();
        mostrar("");
    ...
    void mostrar(String buscar) {
        try {
            ...
            modelo = func.mostrarsubarea(buscar);
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        if (conexion.frmabierto == 1) {
            frmanalisdistrikpi.txtnombresubarea.setText(txtfiltrar.getText());
        } else if (conexion.frmabierto == 5) {
            frmanalisfrecuencia.txtnombresubarea.setText(txtfiltrar.getText());
        }   else if (conexion.frmabierto == 8) {
            frmanalisproyeccion.txtnombresubarea.setText(txtfiltrar.getText());
        } else if (conexion.frmabierto == 9) {
            frmanalisiscompleto.txtnombresubarea.setText(txtfiltrar.getText());
        } else if (conexion.frmabierto == 10) {
            frmanalisisobtpersona.txtnombresubarea.setText(txtfiltrar.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmzfiltrosubarea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmzfiltrosubarea().setVisible(true);
            }
        });
    }
